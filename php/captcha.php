...
define('PATH_TTF', $_SERVER['DOCUMENT_ROOT'] . '/build/fonts/proximanovacond/');
$fonts = array('proximanovacond-semibold-webfont.ttf');
...
$par = array(
	...
	'ALLOWED_CHARS' => 'abcdefghjklmnopqrstuvwxyz23458',
...
// цвета символов
define('CODE_CHAR_COLORS', '#3ba8c0,#48cbe8,#41b9d4,#51daf8');
// цвета линий
define('CODE_LINE_COLORS', '#687b8f,#849db5,#000000,#959aa8');
